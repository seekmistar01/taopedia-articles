...
summary: An in-depth explanation of Yuma Consensus, the mechanism that aggregates validator weights to translate evaluations into incentive allocations across miners and validators.
categories: [bittensor, consensus, incentives]
---
...
References: [Yuma Consensus (learnbittensor.org)](https://docs.learnbittensor.org/yuma-consensus/), [Yuma overview (taostats.io docs)](https://docs.taostats.io/docs/consensus)
...
Reference: [Understanding Incentive Mechanisms](https://docs.learnbittensor.org/learn/anatomy-of-incentive-mechanism)
...
References: [Core Dynamic TAO Concepts](https://docs.bittensor.com/dynamic-tao/dtao-guide), [Emission](https://docs.bittensor.com/emissions)
